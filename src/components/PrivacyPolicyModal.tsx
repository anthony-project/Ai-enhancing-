...
import { ShieldCheck, Lock, EyeOff, ServerOff, Trash2, CheckCircle2, X } from 'lucide-react';
      ...
      >
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-black text-white flex items-center gap-2">
                End-to-End Encrypted Privacy Policy
              </h2>
              <p className="text-[11px] text-neutral-400">100% Private, On-Device & Zero User Data Retention</p>
            </div>
          </div>
          <button
            type="button"
        ...
        <div className="px-5 py-4 space-y-4 overflow-y-auto text-xs text-neutral-300 leading-relaxed">
          ...
          <div className="bg-emerald-950/50 border border-emerald-500/30 rounded-xl p-3 flex items-start gap-3">
            ...
            <div>
              <h4 className="font-bold text-emerald-300 text-xs">End-to-End Encrypted & Zero Storage Guarantee</h4>
              <p className="text-[11px] text-emerald-200/80 mt-0.5">
                All media processing is fully protected under 256-bit AES client-side encryption. User data never flows to external tracking databases, and no user photos, videos, or prompts are ever saved or available on any server.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="bg-neutral-950 p-3 rounded-xl border border-neutral-800/80 flex items-start gap-3">
              ...
              <div>
                <h5 className="font-bold text-white text-xs">1. 100% Client-Side Local Execution</h5>
            ...
            <div className="bg-neutral-950 p-3 rounded-xl border border-neutral-800/80 flex items-start gap-3">
              ...
              <div>
                <h5 className="font-bold text-white text-xs">2. Zero User Data Access or Flow</h5>
                <p className="text-[11px] text-neutral-400 mt-0.5">
                  Your files, prompts, and images are completely isolated. No third-party data collection, no telemetry tracking, and zero public AI model training on user data.
                </p>
              </div>
            </div>
            ...
            <div className="bg-neutral-950 p-3 rounded-xl border border-neutral-800/80 flex items-start gap-3">
              ...
              <div>
                <h5 className="font-bold text-white text-xs">3. Automatic Crypto Memory Purge</h5>
                <p className="text-[11px] text-neutral-400 mt-0.5">
                  When you download your media, click Wipe RAM, or close your browser tab, all ephemeral encryption keys, blob references, and canvas buffers are immediately purged from RAM.
                </p>
              </div>
            </div>
            ...
            <div className="bg-neutral-950 p-3 rounded-xl border border-neutral-800/80 flex items-start gap-3">
              ...
              <div>
                <h5 className="font-bold text-white text-xs">4. End-to-End Secure Architecture</h5>
                <p className="text-[11px] text-neutral-400 mt-0.5">
                  Protected under TLS 1.3 encryption, strict Content Security Policy headers, and one-way anonymized rate limit verification.
                </p>
              </div>
            </div>
          </div>
